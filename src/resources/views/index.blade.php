        ...
        <div class="form">
            ...
            <form class="form__body" action="/confirm" method="POST">
                ...
                <div class="form__group form__group--phone">
                    ...
                    <div class="form__input-box">
                        <input class="form__input form__input--phone" type="text" id="phone1" name="phone1" value="{{ old('phone1', $inputs['phone1'] ?? '') }}" maxlength="5" placeholder="080"> -
                        <input class="form__input form__input--phone" type="text" id="phone2" name="phone2" value="{{ old('phone2', $inputs['phone2'] ?? '') }}" maxlength="5" placeholder="1234"> -
                        <input class="form__input form__input--phone" type="text" id="phone3" name="phone3" value="{{ old('phone3', $inputs['phone3'] ?? '') }}" maxlength="5" placeholder="5678">
                    </div>
                </div>
